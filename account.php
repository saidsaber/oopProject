    ...
    <div class="page-full pb-5">
      <div class="account account--login mt-5 pt-5">
        ...
        <div class="account__register w-100">
          <form class="mb-5" action="App/header/user/register.php" method="post">
            <div class="input-group rounded-1 mb-3">
              <input type="text" name="fullname" class="form-control p-3" placeholder="الاسم كامل"
                aria-label="Username" />
            ...
            <input type="submit" value="حساب جديد" name="register"
