...
$data = ProductController::createProduct($db, $_FILES['image'], $_POST['title'], $_POST['lang'], $_POST['qty'], $_POST['description'], $_POST['compare_price'], $_POST['price'], $_POST['status'], $_POST['category'], $_POST['sub_category'], $_POST['brand']);
echo "<pre>";
if (!$data) {
