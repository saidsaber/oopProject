...
if (isset($_GET["delete"])) {
	ProductController::deleteProduct($db,$_GET["delete"]);
					...
					<div class="card">
						...
						<div class="card-body table-responsive p-0">
							<table class="table table-hover text-nowrap">
								...
								<?php
								$products = ProductController::getAllProduct($db);
								if ($products):
									?>
									<tbody>
										<?php
										foreach ($products as $product):
											...
											<tr>
												<td><?= $product->getId()?></td>
												<td><img src="../assets/images/<?= $product->getImage()?>" class="img-thumbnail" width="50"></td>
												<td><a href="create-product.php?id=<?= $product->getId()?>"><?= $product->getTitle()?></a></td>
												<td><?= $product->getPriceAfterDiscount()?> EGP</td>
												...
												<td>
													<a href="create-product.php?id=<?= $product->getId()?>">
													...
													<a href="?delete=<?= $product->getId()?>" class="text-danger w-4 h-4 mr-1">
