...
if (isset($_GET["delete"])) {
	PagesController::deletePage($db, $_GET["delete"]);
	header(header: "Location: pages.php");
}
?>
<!DOCTYPE html>
<html lang="en">
								...
								<tbody>
									...
									foreach ($pages as $page):
										...
										<tr>
											...
											<td><?= $page->getSlug() ?></td>
											<td>
												<a href="create-page.php?id=<?= $page->getId() ?>">
												...
												<a href="?delete=<?= $page->getId() ?>" class="text-danger w-4 h-4 mr-1">
